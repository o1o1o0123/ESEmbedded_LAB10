...
void set_mpu(void)
{
	...
	//set region 1: sram (0x20000000), 128KB, forbid execution F, full access, enable all subregion
	...
	REG(MPU_BASE + MPU_RBAR_OFFSET) = MPU_RBAR_VALUE(GPIO_BASE(GPIO_PORTD), 2);
	...
	{
		REG(MPU_BASE + MPU_RBAR_OFFSET) = MPU_RBAR_VALUE(0x00000000, region);
